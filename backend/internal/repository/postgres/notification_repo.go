...
// template_id and scheduled_at are deliberately absent — those are populated by the
// Phase 8 (templates) and Phase 9 (scheduling) features.
	...
	row := r.pool.QueryRow(ctx,
		`INSERT INTO notifications
			(id, tenant_id, channel, priority, status, recipient_id, recipient_email, recipient_phone,
			 recipient_token, subject, body, metadata, idempotency_key)
		...
		p.RecipientPhone, p.RecipientToken, p.Subject, p.Body, p.Metadata, idempotencyKey,
	)
