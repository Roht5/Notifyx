...
// scheduled_at is deliberately absent — that's populated by the Phase 9 (scheduling) feature.
	...
	row := r.pool.QueryRow(ctx,
		`INSERT INTO notifications
			(id, tenant_id, channel, priority, status, recipient_id, recipient_email, recipient_phone,
			 recipient_token, template_id, subject, body, metadata, idempotency_key)
		...
		p.RecipientPhone, p.RecipientToken, p.TemplateID, p.Subject, p.Body, p.Metadata, idempotencyKey,
	)
